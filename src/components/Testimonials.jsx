...
const testimonials = [
	{
		...
		quote:
			'Bartender Brothers transformed our corporate event with their exceptional service. The custom cocktails were a hit with our clients, and the bartenders were professional, knowledgeable, and engaging.',
	},
	{
		id: 2,
		name: 'Michael Garcia',
		...
		quote:
			'Hiring Bartender Brothers was the best decision we made for our wedding. Their signature cocktails were stunning, and they accommodated all our guests\' preferences. Everyone is still talking about the drinks!',
	},
	{
		id: 3,
		name: 'Sarah Williams',
		...
		quote:
			'We brought in the team to help develop our seasonal cocktail menu, and the results exceeded our expectations. Their creativity and expertise significantly boosted our beverage program.',
	},
	{
		id: 4,
		name: 'David Chen',
		...
		quote:
			'The mixology workshop was the highlight of my birthday celebration. Everyone had a blast learning to make cocktails, and the bartenders made it fun and accessible for all skill levels.',
	},
];
...
function Testimonials() {
	...
	return (
		<section
			id="reviews"
			className="reviews py-24 bg-gradient-to-b from-dark to-black relative"
		>
			<div className="container mx-auto px-4">
				...
				<div className="max-w-4xl mx-auto relative">
					...
					<button
						onClick={prevSlide}
						className="nav-btn absolute left-0 top-1/2 -translate-y-1/2 z-10 -ml-6 lg:-ml-12 p-3 rounded-full bg-black/70 text-white hover:bg-black/90 transition-colors"
					...
					<button
						onClick={nextSlide}
						className="nav-btn absolute right-0 top-1/2 -translate-y-1/2 z-10 -mr-6 lg:-mr-12 p-3 rounded-full bg-black/70 text-white hover:bg-black/90 transition-colors"
