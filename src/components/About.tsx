        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="aspect-[4/5] w-full rounded-2xl overflow-hidden glass-effect">
              <img 
                src="https://images.unsplash.com/photo-1470337458703-46ad1756a187?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" 
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-['Playfair_Display'] font-bold mb-6 text-white">
              Crafting Memorable Experiences Since <span className="text-cocktail-gold">2015</span>
            </h3>
